...
```bash
python ../../../provenance/query.py runs/03-agent-agent_*   # interactive REPL
python ../../../provenance/query.py runs/03-agent-agent_* --ask "show the cross-agent calls"
python ../../../provenance/query.py runs/03-agent-agent_* --ask "which agent called which action?"
python ../../../provenance/query.py runs/03-agent-agent_* --ask "what did each action transform (used to generated)?"
```
