#!/usr/bin/env python
"""08-discussion -- the value of provenance (thin wrapper over provenance/value.py).

Answers questions the normal output of a multi-agent LLM group chat cannot -- what actually ran, in what
...
is rigorous: wall-clock is the union of overlapping intervals, never a sum.
    ...
    python provenance_value.py runs/08-discussion_*
