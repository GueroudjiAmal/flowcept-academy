#!/usr/bin/env python
"""06-llm -- the value of provenance (thin wrapper over provenance/value.py).

Answers questions the normal output of an LLM deciding to call a cross-agent tool cannot -- what actually ran, in what
...
is rigorous: wall-clock is the union of overlapping intervals, never a sum.
    ...
    python provenance_value.py runs/06-llm_*
