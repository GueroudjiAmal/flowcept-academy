#!/usr/bin/env python
"""03-agent-agent -- the value of provenance (thin wrapper over provenance/value.py).

Answers questions the normal output of a coordinator delegating across agents cannot -- what actually ran, in what
...
is rigorous: wall-clock is the union of overlapping intervals, never a sum.
    ...
    python provenance_value.py runs/03-agent-agent_*
