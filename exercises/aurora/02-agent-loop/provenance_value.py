#!/usr/bin/env python
"""02-agent-loop -- the value of provenance (thin wrapper over provenance/value.py).

Answers questions the normal output of an autonomous @loop cannot -- what actually ran, in what
...
is rigorous: wall-clock is the union of overlapping intervals, never a sum.
    ...
    python provenance_value.py runs/02-agent-loop_*
