#!/usr/bin/env python
"""04-execution -- the value of provenance (thin wrapper over provenance/value.py).

Answers questions the normal output of an agent offloading compute to worker processes cannot -- what actually ran, in what
...
is rigorous: wall-clock is the union of overlapping intervals, never a sum.
    ...
    python provenance_value.py runs/04-execution_*
